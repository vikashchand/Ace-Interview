  ...
  return (
    ...
    <h2 className='text-lg'> <strong> Job Role/Job Position:</strong>{interviewData ? interviewData.jobPosition : "Loading"} </h2>
       ...
       <h2 className='flex gap-2 items-center'>   <Lightbulb/><strong>Information</strong></h2>
          <h2>Enable Video web cam and microphone to start your AI generated Mock Interview.NOTE:We never record Your video,webcam access you can disable anytime if you want</h2>
          </div>
          </div>

    <div>
    {webCamEnabled?     <Webcam onUserMedia={()=> setwebCamEnabled(true)} onUserMediaError={()=> setwebCamEnabled(false)}
    mirrored={true}
    ...
    <Button variant='ghost' onClick={()=>setwebCamEnabled(true)}  className='w-full my-3' > Click to Enable Web Cam and Microphone</Button>
    </>
          }    </div>
